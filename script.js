        ...
        function findResponse(userInput) {
            ...
            for (const rule of knowledgeBase) {
                for (const keyword of rule.keywords) {
                    if (lowerCaseInput.includes(keyword)) return rule.response;
                }
            }
            return 'No he podido comprender su pregunta. Intente reformularla o pregunte por "recomendación", "costo" o "redundancia".';
        }
    }
